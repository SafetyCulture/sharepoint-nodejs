  ...
  _createClass(SharePointAPI, [{
    ...
    */
    ...
    value: function linkLists(list, lookupListId, fieldName, lookupFieldName, multiValues) {
      ...
      return this._axios.post(listURI(list) + '/fields/addfield', {
        ...
        return _this._axios.post(listURI(list) + '/fields(\'' + res.data.d.Id + '\')', {
    ...
    value: function uploadFile(list, fileLocation) {
      ...
      return readFile(fileLocation).then(function (data) {
        ...
        return _this2._axios.post(listURI(list) + '/' + folder + '/Files/Add(url=\'' + fileName + '\', overwrite=true)?$expand=ListItemAllFields', data, { headers: headers }).then(function (response) {
    ...
    value: function attachFileToItem(list, itemId, fileLocation) {
      ...
      return readFile(fileLocation).then(function (data) {
        var headers = { 'content-length': data.length };
        return _this3._axios.post(listURI(list) + '/items({' + itemId + ')/Files/Add(FileName=\'' + fileName + '\', overwrite=true)', data, { headers: headers });
      });
    }
  }, {
    key: 'create',
    ...
    value: function updateItem(list, itemId, item) {
      var url = listURI(list) + '/items/(' + itemId + ')';
      return this.update(url, item);
    }
  }, {
    key: 'getListType',
    value: function getListType(list) {
      return this._axios.post(listURI(list) + '?$select=ListItemEntityTypeFullName', {}, {}).then(function (response) {
    ...
    */
    ...
    value: function getListItems(list) {
      ...
      return this._axios.get(listURI(list) + '/items?' + qs).then(function (res) {
