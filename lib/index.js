...
exports.SharePoint = exports.OAuth2 = exports.Authentication = exports.Batch = exports.sharepointEscapeChars = exports.fillSpaces = exports.libraryType = exports.listType = exports.listURI = exports.LIST_TEMPLATES = exports.FIELD_TYPES = undefined;
  ...
  _createClass(SharePoint, [{
    ...
    */
    ...
    value: function update(resource, body) {
      var headers = _lodash2.default.merge((0, _misc.getAuthHeaders)(this.auth), {
        'Accept': 'application/json;odata=verbose',
        'User-Agent': _misc.USER_AGENT,
        'IF-MATCH': '*',
        'X-HTTP-Method': 'MERGE',
