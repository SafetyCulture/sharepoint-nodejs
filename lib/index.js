...
exports.SharePoint = exports.OAuth2 = exports.Authentication = exports.Batch = exports.fillSpaces = exports.listType = exports.listURI = exports.LIST_TEMPLATES = exports.FIELD_TYPES = undefined;
...
var SharePoint = exports.SharePoint = function () {
  ...
  */
  ...
  _createClass(SharePoint, [{
    ...
    key: 'getAuthHeaders',
    value: function getAuthHeaders(auth) {
    ...
    */
    ...
    value: function linkLists(list, lookupListId, fieldName, lookupFieldName, multiValues) {
      ...
      return this._axios.post((0, _lists.listURI)(list) + '/fields/addfield', {
        ...
        return _this2._axios.post((0, _lists.listURI)(list) + '/fields(\'' + res.data.d.Id + '\')', {
    ...
    */
    ...
    value: function getListItems(list) {
      ...
      if (where) {
        query.$filter = _lodash2.default.map((0, _lists.fillSpaces)(where), function (value, field) {
